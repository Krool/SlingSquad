...
export interface StructureContext {
  ...
  /** Place a shard crystal at (x,y) — TREASURE nodes only */
  shard?(x: number, y: number): void;
  /** Place a chest sensor at (x,y) — TREASURE nodes only */
  chest?(x: number, y: number): void;
